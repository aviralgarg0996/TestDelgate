...
export default class PasswordStrengthInput extends Component {
  static defaultProps = {
    ...
    strengthLevels: [
      ...
      },
      {
        ...
        widthPercent: '100',
        innerBarColor: Constants.Colors.Blue,
      }
    ],
    tooShort: {
      enabled: false,
  ...
  onBlur() {
    this.setState({ isFocused: false, focusColor  : Constants.Colors.Blue,borderBottomWidth:1 });
  ...
  onFocus(){
    let colour = this.props.focusColor ? this.props.focusColor : Constants.Colors.Blue;
