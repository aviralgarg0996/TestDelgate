...
class PhoneVerification extends Component<{}> {
  ...
  onPress()
  {
   ...
   // let { dispatch } = this.props.navigation.dispatch;
    ...
    this.props.UserActions.phoneVerification({...this.state});
  }
        ...
        <View  style={[styles.modalOuter]}>
            <View  style={styles.modalInner}>
              <KeyboardAvoidingView behavior={'position'}>
                <TouchableHighlight underlayColor={Constants.Colors.Orange} style={[styles.btCloseModal]} onPress={() => {this.props.dispatch.dispatch({type : 'PHONEVERIFICATION_VISIBILITY', visibility:false})}}>
