...
class EmailVerification extends Component<{}> {
  ...
  onPress()
  {
   ...
   // let { dispatch } = this.props.dispatch;
    ...
    this.props.UserActions.emailVerification({...this.state});
  }
        ...
        <View  style={[styles.modalOuter]}>
            <View  style={styles.modalInner}>
              <KeyboardAvoidingView behavior={'position'}>
                <TouchableHighlight underlayColor={Constants.Colors.Orange} style={[styles.btCloseModal]} onPress={() => {this.props.dispatch.dispatch({type : 'EMAILVERIFICATION_VISIBILITY', visibility:false})}}>
