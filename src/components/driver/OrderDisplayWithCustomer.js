    ...
    return (
        <View style={{ backgroundColor: Constants.Colors.White }}>
              <View style={{marginHorizontal: (Constants.BaseStyle.DEVICE_WIDTH/100)*4,marginVertical: Constants.BaseStyle.DEVICE_WIDTH*2/100}}>
                <TouchableOpacity onPress={() => {this.props.dispatch({type : 'SET_SCREENSIZE',flag:false})}}>
                  <Image
...
export default connect(state => ({modalstate: state.ModalHandleReducer}))(OrderDisplayWithCustomer);
