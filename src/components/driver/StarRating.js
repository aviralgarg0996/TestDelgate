...
export default class StarRating extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      iconSelected: this.props.iconSelected? this.props.iconSelected: Constants.Images.driver.staryellow,
      iconUnselected: this.props.iconUnselected? this.props.iconUnselected: Constants.Images.driver.star,
