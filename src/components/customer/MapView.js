...
class CustomerMapView extends Component<{}> {
  ...
  render() {
    ...
    const shadowForEstimate = {width:Constants.BaseStyle.DEVICE_WIDTH/100*95,
                        ...
                        x:2,
                        y:2,
                        style:{bottom: Constants.BaseStyle.DEVICE_HEIGHT / 100 * 23,
    ...
    const shadowForPickup = {width:Constants.BaseStyle.DEVICE_WIDTH/100*95,
                            ...
                            x:2,
                            y:2,
                            style:{bottom: Constants.BaseStyle.DEVICE_HEIGHT / 100 * 91,
                            marginHorizontal: Constants.BaseStyle.DEVICE_WIDTH / 100 * 2,}
    };
        ...
        <View style={[styles.rootContainer]}>
            <MapView
              ...
              {/*<MapView.Marker
                ...
                title={"Your Location"} image={Constants.Images.customer.pickup}
                >
              </MapView.Marker>*/}
