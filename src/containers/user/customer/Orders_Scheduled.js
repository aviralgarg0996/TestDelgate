  ...
  render() {
    ...
    var _generalList=this.state.generalList.map((val,b) => {
      return(
        <BoxShadow setting={{width:Constants.BaseStyle.DEVICE_WIDTH,
          ...
          <View style={[styles.container,{backgroundColor:'#ffffff',height:Constants.BaseStyle.DEVICE_HEIGHT/100 * 17}]}>
    ...
    return (
      <View style={[styles.container,{backgroundColor:Constants.Colors.White}]}>
        <HeaderBackgroundWithBackButton navigation={navigate} goBack={goBack} headerText={'Scheduled Order'}/>
        <BoxShadow setting={{width:Constants.BaseStyle.DEVICE_WIDTH,
                            height:Constants.BaseStyle.DEVICE_HEIGHT/100 * 48,
                            color:"#000",
                            border:3,
                            radius:5,
                            opacity:0.1,
...
export default connect(state => ({state: state.CustomerReducer}))(Orders_Scheduled);
